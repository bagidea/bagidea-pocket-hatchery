/**
 * Shared template_id resolver — CommonJS version (for .cjs scripts)
 *
 ...
 *   const tid = await resolveTemplateId('phgamecreatr');
 */
 ...
 */
async function resolveTemplateId(collectionName, rpc, opts) {
  rpc = rpc || DEFAULT_RPC;
 ...
 */
async function resolveAllTemplates(collectionName, rpc, opts) {
  rpc = rpc || DEFAULT_RPC;
...
module.exports = { resolveTemplateId, resolveAllTemplates };
